...
\restrict xy8TxJ5P6FYiMScWzIgyqzXWHWhcRDzt1P4vtcG0W6bQbLkfoTzftUXatE0wVrU
...
214	tec-logica	Si mi prima es hija de la hermana de mi madre, ¿qué relación tiene conmigo la abuelita materna de la hija de mi prima?	\N	["Tía", "Prima", "Madre", "Abuela"]	[{"expl": "La hermana de mi madre es mi tía; por tanto, mi prima es hija de mi tía.", "math": "\\\\text{Prima = hija de la hermana de mi madre}"}, {"expl": "La abuelita materna de esa hija es la madre de mi prima.", "math": "\\\\text{Hija de mi prima}"}, {"expl": "La madre de mi prima es la hermana de mi madre. La respuesta correcta es tía.", "math": "\\\\text{Madre de mi prima = mi tía}"}]	basico	2026-05-15 14:14:28.214395	Conceptos: árbol familiar, relación materna, sustitución de relaciones. Biblioteca sugerida: TEC/PAA Lógica.	tec_paa	2022	cuaderno_de_ejercicios_para_la_paa.pdf | p. 5 | ítem 1
215	tec-matematica	Considere la secuencia: 1/(n² + 1), 3/(n⁴ + 2), 5/(n⁶ + 3). ¿Cuál expresión continúa?	\\frac{1}{n^2+1},\\ \\frac{3}{n^4+2},\\ \\frac{5}{n^6+3}	["7/(n⁸ + 4)", "7/(n⁸ + 3)", "6/(n⁸ + 3)", "7/(n⁸ + 5)"]	[{"expl": "El numerador aumenta de 2 en 2: 1, 3, 5; el siguiente es 7.", "math": "1,3,5,\\\\ldots"}, {"expl": "El exponente de n aumenta de 2 en 2: 2, 4, 6; el siguiente es 8.", "math": "n^2,n^4,n^6,\\\\ldots"}, {"expl": "El término sumado al denominador aumenta de 1 en 1; el siguiente es 4.", "math": "1,2,3,\\\\ldots"}, {"expl": "Se combinan los tres patrones. La expresión que continúa es 7/(n⁸ + 4).", "math": "\\\\frac{7}{n^8+4}"}]	basico	2026-05-15 14:14:28.224592	Conceptos: secuencias, patrones independientes, numerador y denominador. Biblioteca sugerida: TEC/PAA Matemática.	tec_paa	2022	cuaderno_de_ejercicios_para_la_paa.pdf | p. 6 | ítem 2
216	tec-logica	Premisa 1: Todos los ciervos tienen cuernos. Premisa 2: Algunos rumiantes son ciervos. ¿Qué se sigue?	\N	["Algunos rumiantes tienen cuernos", "Algunos ciervos no son rumiantes", "Todos los rumiantes tienen cuernos", "Algunos rumiantes no tienen cuernos"]	[{"expl": "La primera premisa garantiza que cada ciervo pertenece al grupo de animales con cuernos.", "math": "\\\\text{Ciervos} \\\\Rightarrow \\\\text{cuernos}"}, {"expl": "La segunda premisa une una parte de los rumiantes con los ciervos.", "math": "\\\\text{Algunos rumiantes son ciervos}"}, {"expl": "Solo esa parte de rumiantes que son ciervos queda garantizada con cuernos.", "math": "\\\\text{Algunos rumiantes} \\\\Rightarrow \\\\text{cuernos}"}]	basico	2026-05-15 14:14:28.22541	Conceptos: silogismos, cuantificadores, algunos/todos, conclusión necesaria. Biblioteca sugerida: TEC/PAA Lógica.	tec_paa	2022	cuaderno_de_ejercicios_para_la_paa.pdf | p. 7 | ítem 3
217	tec-logica	Premisas: Si V lee, entonces L dibuja o J salta. Si L dibuja, entonces P no corre. L no dibuja y J no salta. ¿Qué se concluye?	\N	["V no lee", "V lee", "P corre", "P no corre"]	[{"expl": "La primera premisa dice que leer obliga a que ocurra al menos una de dos cosas: L dibuja o J salta.", "math": "V \\\\Rightarrow (L \\\\lor J)"}, {"expl": "La tercera premisa niega ambas posibilidades del consecuente.", "math": "\\\\neg L \\\\land \\\\neg J"}, {"expl": "Por contraposición, si no ocurre L ni J, entonces V no lee.", "math": "\\\\neg(L \\\\lor J) \\\\Rightarrow \\\\neg V"}, {"expl": "La premisa sobre P depende de que L dibuje; como L no dibuja, no permite concluir si P corre o no.", "math": "\\\\text{P no queda determinado}"}]	basico	2026-05-15 14:14:28.226084	Conceptos: condicional, disyunción, negación, contraposición. Biblioteca sugerida: TEC/PAA Lógica.	tec_paa	2022	cuaderno_de_ejercicios_para_la_paa.pdf | p. 8 | ítem 4
218	tec-logica	En el patrón tipo triángulo de Pascal, se analizan las afirmaciones A, B y C. ¿Cuáles se cumplen con certeza?	\N	["B y C", "A y B", "Solo B", "Solo C"]	[{"expl": "En una fila del triángulo no aparecen necesariamente el número de fila y su consecutivo como afirma A.", "math": "\\\\text{A es falsa}"}, {"expl": "El número 2 puede estar rodeado por números impares en el arreglo mostrado.", "math": "\\\\text{B es verdadera}"}, {"expl": "Al extender filas se verifica que 28 aparece dentro del grupo que rodea al 7.", "math": "\\\\text{C es verdadera}"}, {"expl": "Solo B y C quedan comprobadas con certeza.", "math": "\\\\text{Conclusión: B y C}"}]	basico	2026-05-15 14:14:28.226689	Conceptos: patrón numérico, verificación de afirmaciones, certeza. Biblioteca sugerida: TEC/PAA Lógica.	tec_paa	2022	cuaderno_de_ejercicios_para_la_paa.pdf | pp. 9-10 | ítem 5
219	tec-logica	Tres lapiceros X, Y y Z: dos son verdes y uno es rojo. Además, X y Y son de diferente color. ¿Qué proposición se cumple con certeza?	\N	["Z es verde", "Y es verde", "X es verde", "Y y X son verdes"]	[{"expl": "Solo uno de los tres lapiceros puede ser rojo.", "math": "\\\\text{Hay dos verdes y un rojo}"}, {"expl": "Como X y Y son de diferente color, uno de ellos es rojo y el otro verde.", "math": "X \\\\neq Y"}, {"expl": "El rojo ya está entre X y Y. Por eso Z necesariamente es verde.", "math": "\\\\text{Z no puede ser rojo}"}]	basico	2026-05-15 14:14:28.227476	Conceptos: casos posibles, certeza, descarte por restricción. Biblioteca sugerida: TEC/PAA Lógica.	tec_paa	2022	cuaderno_de_ejercicios_para_la_paa.pdf | p. 11 | ítem 6
220	tec-matematica	Aproxime 0,428571 a la milésima.	0.428571	["0,429", "0,428", "0,430", "0,42"]	[{"expl": "La milésima es la tercera cifra decimal: 8 en 0,428.", "math": "0,428\\\\,571"}, {"expl": "Para redondear se mira la cuarta cifra decimal. Es 5, entonces se aumenta la milésima.", "math": "\\\\text{Siguiente cifra}=5"}, {"expl": "El 8 sube a 9. Resultado: 0,429.", "math": "0,428 \\\\to 0,429"}]	basico	2026-05-15 14:14:28.228049	Conceptos: valor posicional, redondeo decimal, milésima. Biblioteca sugerida: TEC/PAA Matemática.	tec_paa	\N	Prueba Racionalización Parte 1.pdf | p. 1 y p. 4 | ejercicio 1.1
221	tec-matematica	Aproxime -3,141592 a la diezmilésima.	-3.141592	["-3,1416", "-3,1415", "-3,1420", "-3,1410"]	[{"expl": "La diezmilésima es la cuarta cifra decimal: 5 en -3,1415.", "math": "-3,1415\\\\,92"}, {"expl": "La quinta cifra decimal es 9, así que se redondea hacia la centésima de diezmilésima siguiente.", "math": "\\\\text{Siguiente cifra}=9"}, {"expl": "En redondeo usual, la magnitud queda -3,1416.", "math": "-3,1415 \\\\to -3,1416"}]	basico	2026-05-15 14:14:28.228657	Conceptos: redondeo con números negativos, valor posicional. Biblioteca sugerida: TEC/PAA Matemática.	tec_paa	\N	Prueba Racionalización Parte 1.pdf | p. 1 y p. 4 | ejercicio 1.2
222	tec-matematica	Clasifique 0,875 como expansión decimal exacta o periódica.	0.875	["Exacta", "Periódica", "Mixta", "Irracional"]	[{"expl": "El número tiene una cantidad finita de cifras decimales.", "math": "0,875"}, {"expl": "Puede escribirse como fracción con denominador potencia de 10 y simplificarse.", "math": "\\\\frac{875}{1000}=\\\\frac{7}{8}"}, {"expl": "Como termina, no repite un bloque infinito. Es decimal exacta.", "math": "\\\\text{Decimal exacta}"}]	basico	2026-05-15 14:14:28.229214	Conceptos: decimal exacto, decimal periódico, fracción decimal. Biblioteca sugerida: TEC/PAA Matemática.	tec_paa	\N	Prueba Racionalización Parte 1.pdf | p. 1 y p. 4 | ejercicio 2.1
223	tec-matematica	Convierta 5/8 a decimal.	\\frac{5}{8}	["0,625", "0,58", "0,825", "1,6"]	[{"expl": "Para convertir una fracción a decimal, se divide el numerador entre el denominador.", "math": "5 \\\\div 8"}, {"expl": "Como 8 divide a 1000 exactamente, el decimal termina.", "math": "5 \\\\div 8 = 0,625"}, {"expl": "Resultado final: 0,625.", "math": "\\\\frac{5}{8}=0,625"}]	basico	2026-05-15 14:14:28.229849	Conceptos: fracción a decimal, división, decimal exacto. Biblioteca sugerida: TEC/PAA Matemática.	tec_paa	\N	Prueba Racionalización Parte 1.pdf | p. 2 y p. 4 | ejercicio 3.1
224	tec-matematica	Convierta -2,75 a fracción impropia y número mixto.	-2.75	["-11/4 y -2 3/4", "-9/4 y -2 1/4", "-7/5 y -2 3/5", "-275/10 y -27 5/10"]	[{"expl": "Se escribe el decimal sobre 100 porque tiene dos cifras decimales.", "math": "-2,75=-\\\\frac{275}{100}"}, {"expl": "Se simplifica dividiendo numerador y denominador entre 25.", "math": "-\\\\frac{275}{100}=-\\\\frac{11}{4}"}, {"expl": "11 ÷ 4 da 2 y sobran 3. Como el número es negativo, queda -2 3/4.", "math": "-\\\\frac{11}{4}= -2\\\\frac{3}{4}"}]	basico	2026-05-15 14:14:28.230558	Conceptos: decimal a fracción, simplificación, número mixto. Biblioteca sugerida: TEC/PAA Matemática.	tec_paa	\N	Prueba Racionalización Parte 1.pdf | p. 2 y p. 4 | ejercicio 3.2
225	tec-matematica	¿Cuántos números pares distintos de tres cifras se pueden formar usando los dígitos 5, 2 y 4, permitiendo repetir dígitos?	\N	["18", "27", "12", "6"]	[{"expl": "Para que el número sea par, la última cifra debe ser 2 o 4.", "math": "\\\\text{Unidad par: }2\\\\text{ opciones}"}, {"expl": "La primera cifra puede ser 5, 2 o 4.", "math": "\\\\text{Centena: }3\\\\text{ opciones}"}, {"expl": "La cifra del medio también puede ser cualquiera de las tres.", "math": "\\\\text{Decena: }3\\\\text{ opciones}"}, {"expl": "Multiplicamos las decisiones independientes. Se pueden formar 18 números.", "math": "3\\\\cdot3\\\\cdot2=18"}]	basico	2026-05-15 14:14:28.231084	Conceptos: conteo por etapas, números pares, principio multiplicativo. Biblioteca sugerida: TEC/PAA Matemática.	tec_paa	2024	Practica_PAA_2024_2025.pdf | p. 9 y p. 45 | ítem 2
226	tec-matematica	Un hombre enumera 12 cajas del 1 al 12. En una caja puso 1 en lugar del número correcto y la suma resultó 71. ¿En cuál caja se equivocó?	1+2+\\cdots+12=78	["8", "12", "10", "7"]	[{"expl": "La suma correcta de 1 a 12 es 78.", "math": "\\\\frac{12\\\\cdot13}{2}=78"}, {"expl": "La suma bajó 7 unidades por cambiar un número por 1.", "math": "78-71=7"}, {"expl": "Si el número correcto era x y se escribió 1, la pérdida fue x - 1.", "math": "x-1=7"}, {"expl": "La caja correcta era la número 8.", "math": "x=8"}]	basico	2026-05-15 14:14:28.231566	Conceptos: suma consecutiva, diferencia, ecuación simple. Biblioteca sugerida: TEC/PAA Matemática.	tec_paa	2024	Practica_PAA_2024_2025.pdf | p. 10 y p. 45 | ítem 3
227	tec-matematica	En 5 partidos de fútbol un equipo tiene 2 goles en contra. Si ganó los 5 partidos, ¿cuántos goles a favor debe tener como mínimo?	\N	["7", "5", "6", "8"]	[{"expl": "Para ganar un partido, los goles a favor deben superar los goles en contra de ese partido.", "math": "\\\\text{Cada victoria exige ventaja mínima de 1}"}, {"expl": "En partidos 1-0 se necesita al menos un gol por victoria.", "math": "\\\\text{Tres partidos sin goles en contra} \\\\Rightarrow 3\\\\text{ goles}"}, {"expl": "Si en dos partidos recibe un gol, gana mínimo 2-1 cada uno: dos goles a favor por partido.", "math": "\\\\text{Dos goles en contra repartidos} \\\\Rightarrow 4\\\\text{ goles}"}, {"expl": "El mínimo total de goles a favor es 7.", "math": "3+4=7"}]	basico	2026-05-15 14:14:28.232061	Conceptos: mínimo, desigualdad por caso, interpretación deportiva. Biblioteca sugerida: TEC/PAA Matemática.	tec_paa	2024	Practica_PAA_2024_2025.pdf | p. 10 y p. 45 | ítem 4
228	tec-matematica	En un pueblo hay una mujer por cada dos hombres y tres niños por cada hombre. Si hay 50 hombres, ¿cuántas personas hay en total?	\N	["225", "125", "175", "250"]	[{"expl": "Tomamos los 50 hombres como dato base.", "math": "50\\\\text{ hombres}"}, {"expl": "Una mujer por cada dos hombres: 50 ÷ 2 = 25.", "math": "\\\\frac{1\\\\text{ mujer}}{2\\\\text{ hombres}}\\\\Rightarrow 25\\\\text{ mujeres}"}, {"expl": "Tres niños por cada hombre: 3 · 50 = 150.", "math": "3\\\\text{ niños por hombre}\\\\Rightarrow150\\\\text{ niños}"}, {"expl": "Total de personas: hombres + mujeres + niños = 225.", "math": "50+25+150=225"}]	basico	2026-05-15 14:14:28.232521	Conceptos: razón, proporción, total por categorías. Biblioteca sugerida: TEC/PAA Matemática.	tec_paa	2024	Practica_PAA_2024_2025.pdf | p. 10 y p. 45 | ítem 5
229	tec-verbal	Según el texto, ¿cuáles palabras son equivalentes a “paradójico” y “trascendencia”?	\N	["absurdo - importancia", "controversial - eficacia", "incomprensible - necesidad", "cuestionable - consecuencia"]	[{"expl": "En el contexto, algo paradójico parece contradictorio o sin sentido; por eso se aproxima a absurdo.", "math": "\\\\text{paradójico}"}, {"expl": "La palabra trascendencia apunta a relevancia o importancia.", "math": "\\\\text{trascendencia}"}, {"expl": "Es la única pareja que conserva el sentido de ambas palabras dentro del texto.", "math": "\\\\text{absurdo - importancia}"}]	basico	2026-05-15 14:14:28.233019	Conceptos: sinonimia contextual, vocabulario, pistas semánticas. Biblioteca sugerida: TEC/PAA Verbal.	tec_paa	2022	cuaderno_de_ejercicios_para_la_paa.pdf | p. 58 | verbal ítem 1
230	tec-verbal	Según el texto sobre la televisión, ¿cuál palabra resume mejor su efecto?	\N	["Seductora", "Nociva", "Ilusoria", "Atractiva"]	[{"expl": "El texto presenta un efecto de atracción intensa, casi hipnótica.", "math": "\\\\text{Pistas: tantaliza, prendados, mágico}"}, {"expl": "Seductora resume la idea de atraer y atrapar.", "math": "\\\\text{seducir = cautivar}"}, {"expl": "Nociva o ilusoria agregan ideas que el texto no necesita; atractiva es más débil.", "math": "\\\\text{Respuesta: Seductora}"}]	basico	2026-05-15 14:14:28.23349	Conceptos: síntesis semántica, palabra que engloba, lectura contextual. Biblioteca sugerida: TEC/PAA Verbal.	tec_paa	2022	cuaderno_de_ejercicios_para_la_paa.pdf | p. 59 | verbal ítem 2
231	tec-verbal	En el texto sobre el latín y Roma, ¿cuáles palabras completan el párrafo con sentido lógico?	\N	["rústica - expandirse", "antigua - dividirse", "exótica - distribuirse", "arcaica - transmitirse"]	[{"expl": "Esas pistas describen un habla sencilla o poco refinada: rústica.", "math": "\\\\text{pastores, campesinos, soldados rudos}"}, {"expl": "Las conquistas permiten que el idioma se extienda fuera de su lugar inicial.", "math": "\\\\text{victoria tras victoria}"}, {"expl": "Ambas palabras mantienen coherencia con el contexto completo.", "math": "\\\\text{rústica - expandirse}"}]	basico	2026-05-15 14:14:28.234018	Conceptos: coherencia textual, completar párrafo, campo semántico. Biblioteca sugerida: TEC/PAA Verbal.	tec_paa	2022	cuaderno_de_ejercicios_para_la_paa.pdf | p. 60 | verbal ítem 3
232	tec-verbal	Según el texto “Disculpen esta impericia... No soy escritor”, ¿cuál palabra equivale a “impericia”?	\N	["Incompetencia", "Desorden", "Accidente", "Negligencia"]	[{"expl": "La pista indica falta de habilidad para escribir.", "math": "\\\\text{No soy escritor}"}, {"expl": "Impericia se relaciona con no dominar una actividad.", "math": "\\\\text{impericia = falta de destreza}"}, {"expl": "Incompetencia es la opción más cercana al sentido contextual.", "math": "\\\\text{Respuesta: Incompetencia}"}]	basico	2026-05-15 14:14:28.23457	Conceptos: vocabulario en contexto, sinónimo, pista textual. Biblioteca sugerida: TEC/PAA Verbal.	tec_paa	2022	cuaderno_de_ejercicios_para_la_paa.pdf | p. 64 | verbal ítem 7
233	tec-verbal	“La vida humana acontece solo una vez...” En esta frase se evidencia que la vida humana...	\N	["es una experiencia irrepetible", "es frágil e imperfecta", "consiste en tomar decisiones sabias", "nos dicta cómo debe ser nuestro actuar"]	[{"expl": "La frase central indica que la vida no se repite.", "math": "\\\\text{solo una vez}"}, {"expl": "La imposibilidad de comparar viene de que no hay segunda oportunidad idéntica.", "math": "\\\\text{no podremos averiguar todas las decisiones}"}, {"expl": "Esa opción sintetiza la inferencia autorizada por el texto.", "math": "\\\\text{experiencia irrepetible}"}]	basico	2026-05-15 14:14:28.235189	Conceptos: inferencia, idea implícita, lectura de frase. Biblioteca sugerida: TEC/PAA Verbal.	tec_paa	2024	Practica_PAA_2024_2025.pdf | p. 37 y p. 46 | ítem 67
234	tec-verbal	En el texto sobre Facebook, ¿cuál contradicción aparece?	\N	["Facebook es una red social; sin embargo, podría separarte del mundo", "En Facebook se intercambian fotos, pero no videos", "Facebook permite conversar en realidades tangibles", "Se intercambian comentarios, pero ninguno es valioso"]	[{"expl": "El texto reconoce que Facebook permite conversar y compartir.", "math": "\\\\text{red social}"}, {"expl": "Luego advierte que puede absorber tiempo y alejar de la convivencia real.", "math": "\\\\text{desconecta del mundo tangible}"}, {"expl": "La tensión es que una red social puede terminar separando del mundo social real.", "math": "\\\\text{contradicción}"}]	basico	2026-05-15 14:14:28.235792	Conceptos: contradicción textual, idea explícita e implícita, intención del autor. Biblioteca sugerida: TEC/PAA Verbal.	tec_paa	2024	Practica_PAA_2024_2025.pdf | pp. 42-43 y p. 46 | ítem 77
\.
...
SELECT pg_catalog.setval('public.exercises_id_seq', 234, true);
...
SELECT pg_catalog.setval('public.knowledge_library_id_seq', 52, true);
...
\unrestrict xy8TxJ5P6FYiMScWzIgyqzXWHWhcRDzt1P4vtcG0W6bQbLkfoTzftUXatE0wVrU
